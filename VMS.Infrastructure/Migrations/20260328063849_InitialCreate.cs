        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    OrganisationType = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    Status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Visitors_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Visitors_Users_DeletedBy",
                        column: x => x.DeletedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Visitors_Users_UpdatedBy",
                        column: x => x.UpdatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TokenNumber = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VisitorTokens", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VisitorTokens_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VisitorTokens_Users_DeletedBy",
                        column: x => x.DeletedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VisitorTokens_Users_UpdatedBy",
                        column: x => x.UpdatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VisitorTokens_Visitors_VisitorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Hosts_CreatedBy",
                table: "Hosts",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_Hosts_DeletedBy",
                table: "Hosts",
                column: "DeletedBy");

            migrationBuilder.CreateIndex(
                name: "IX_Hosts_UpdatedBy",
                table: "Hosts",
                column: "UpdatedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Organisations_DeletedBy",
                table: "Organisations",
                column: "DeletedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Visitors_CreatedBy",
                table: "Visitors",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_Visitors_DeletedBy",
                table: "Visitors",
                column: "DeletedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Visitors_UpdatedBy",
                table: "Visitors",
                column: "UpdatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_VisitorTokens_CreatedBy",
                table: "VisitorTokens",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_VisitorTokens_DeletedBy",
                table: "VisitorTokens",
                column: "DeletedBy");

            migrationBuilder.CreateIndex(
                name: "IX_VisitorTokens_TokenNumber",
                table: "VisitorTokens",
                column: "TokenNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VisitorTokens_UpdatedBy",
                table: "VisitorTokens",
                column: "UpdatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_VisitorTokens_VisitorId",
                table: "VisitorTokens",
                column: "VisitorId");

            migrationBuilder.AddForeignKey(
                name: "FK_Appointments_Hosts_HostId",
                table: "Appointments",
                column: "HostId",
                principalTable: "Hosts",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Organisations_Users_DeletedBy",
                table: "Organisations",
                column: "DeletedBy",
                principalTable: "Users",
                principalColumn: "Id",
